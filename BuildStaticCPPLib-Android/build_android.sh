...
if [[ $1 = "device" ]]; then
  gn gen ios_out/arm64 --args='target_os="ios" target_cpu="arm64" target_environment="device"'
  ninja -C ios_out/arm64
elif [[ $1 = "simulator" ]]; then
  gn gen ios_out/x64 --args='target_os="ios" target_cpu="x64" target_environment="simulator"'
  ninja -C ios_out/x64
elif [[ $1 = "all" ]]; then
  gn gen ios_out/arm64 --args='target_os="ios" target_cpu="arm64" target_environment="device"'
  ninja -C ios_out/arm64
